...
# ============================================================
# INJETANDO A CHAVE DIRETAMENTE NO .ENV E NO CONFIG
# ============================================================
RUN echo "APP_KEY=base64:uS68On6HInL6p9G6nS8z2mB1vC4xR7zN0jK3lM6pQ9w=" > .env
...
# Script de inicialização limpo e direto
